        ...
        return (
            ...
            <Loader loading={this.state.loading} />
                ...
                <View style={styles.logoContainer}>
                    ...
                    <Text style={styles.logoText}>Authentification </Text>
                </View>
                ...
                <TouchableOpacity style={styles.btnLogin } onPress={() => this.props.navigation.navigate('Main')}>
                    ...
                    <Text style={styles.regText} onPress={() => this.props.navigation.navigate('SignUp')} >Modifiez votre mot de passe ici!</Text>
                    </KeyboardAwareScrollView>
            </ImageBackground>
            </React.Fragment>
        )
